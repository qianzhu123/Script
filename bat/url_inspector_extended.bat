...
echo ============================================================
echo URLsecuritycheck - extended
echo silentscanmode,final result.
echo ============================================================
echo.
set /p "TARGET_URL=Paste fullURLpress Enter: "
...
:print_summary
echo URLresult: %URL_RESULT%
echo structureresult: %STRUCTURE_RESULT%
echo DNSresult: %DNS_RESULT%
echo HTTPresult: %HTTP_RESULT%
echo TLSresult: %TLS_RESULT%
echo WHOISresult: %WHOIS_RESULT%
echo Pingresult: %PING_RESULT%
echo routeresult: %TRACE_RESULT%
echo overallresult: %OVERALL_RESULT%
exit /b 0

:display_summary
title URLsecuritycheck - result
echo ============================
echo URLsecuritycheck - result
echo ============================
echo.
echo URLresult: %URL_RESULT%
echo structureresult: %STRUCTURE_RESULT%
